...
video_capture = cv2.VideoCapture(0)    #Web Cam access, testing data, frame by frame process hoga


def camera_stream():
    # variable to process alternate frames
    ...
    while True:
        ...
        for (x, y, w, h) in face_locations:
            ...
            cv2.putText(frame, "No Mask", (x + 6, y - 6), font, 1.0, (255, 255, 255), 1)

        # if no defaulters are found
        #if (face_found == False):
        if (len(face_locations) == 0):
            # draw green box to show ok status
            frame = cv2.rectangle(frame, (50, 50), (600, 450), (0, 255, 0), 3)
            #cv2.rectangle(frame, (50, 400 - 35), (500, 650), (255, 255, 255), cv2.FILLED)
            font = cv2.FONT_HERSHEY_DUPLEX
            cv2.putText(frame, "Mask Detected", (200, 450 - 6), font, 1.0, (0, 255, 0), 1)
